...
class PostViewModel : ViewModel() {
    ...
    var shouldOpenCommentsFromNotif by mutableStateOf(false)
    ...
    val filteredPosts: StateFlow<List<Post>> = combine(
        ...
        posts.filter { post ->
            ...
            val matchesQuery = cleanQuery.isBlank() ||
                    ...
                    post.fullAddress.lowercase().contains(cleanQuery) ||
    ...
    private fun fetchPosts() {
        firestore.collection("posts")
            ...
            .addSnapshotListener { snapshot, e ->
                if (e != null) {
                    Log.e("PostViewModel", "Erreur récupération posts: ${e.message}")
    ...
    fun fetchLikersDetails(userIds: List<String>) {
        ...
        viewModelScope.launch {
            try {
                ...
                Log.e("PostViewModel", "Erreur récupération likers: ${e.message}")
                _likersDetails.value = emptyList()
            }
        }
    }
    ...
    fun toggleFavorite(postId: String) {
        ...
        viewModelScope.launch {
            try {
                ...
                Log.e("PostViewModel", "Erreur favoris: ${e.message}")
            }
        }
    }
    ...
    fun addComment(post: Post, text: String) {
        ...
        viewModelScope.launch {
            try {
                ...
                Log.e("PostViewModel", "Erreur ajout commentaire: ${e.message}")
            }
        }
    }
    ...
    fun deleteComment(postId: String, comment: Comment) {
        viewModelScope.launch {
            try {
                ...
                Log.e("PostViewModel", "Erreur suppression commentaire: ${e.message}")
            }
        }
    }
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                val postData = hashMapOf(
                    ...
                    "fullAddress" to fullAddress.ifBlank { location },
    ...
    fun reportPost(post: Post) {
        viewModelScope.launch {
            try {
                ...
                Log.e("PostViewModel", "Erreur signalement: ${e.message}")
            }
        }
    }
    ...
    private fun sendNotification(
        ...
        viewModelScope.launch {
            try {
                ...
                Log.e("PostViewModel", "Erreur notification: ${e.message}")
            }
        }
    }
